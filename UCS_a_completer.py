...
def ucs_initialiser(depart):
    ...
    """
    # TODO: initialiser la file de priorité (heap) et l'état
    raise NotImplementedError("TODO: implémenter ucs_initialiser(depart)")
...
def ucs_faire_une_etape(grille, etat, arrivee, couts):
    ...
    """
    # TODO: implémenter une étape UCS (Dijkstra)
    raise NotImplementedError("TODO: implémenter ucs_faire_une_etape(grille, etat, arrivee, couts)")
...
def reconstruire_chemin(parent, depart, arrivee):
    ...
    raise NotImplementedError("TODO: implémenter reconstruire_chemin(parent, depart, arrivee)")
